...
(function() {
  ...
  constants = ['STREAM_INPUT', 'STREAM_OUTPUT', 'STREAM_IMAGE', 'TILE_COMPUTE', 'TILE_MEMORY', 'TILE_DAMAGED'];
  ...
  exports.parse = function(contents) {
    ...
    for (i = l = 0, len1 = streams.length; l < len1; i = ++l) {
      ...
      if (type !== 'STREAM_INPUT' && type !== 'STREAM_OUTPUT' && type !== 'STREAM_IMAGE') {
        throw new Error("Unknown stream type '" + type + "' at stream " + i);
      }
      if (type !== 'STREAM_IMAGE' && !/\S/.test(name)) {
